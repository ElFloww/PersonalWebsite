    ...
    <v-container fluid class="hero-container">
      <v-row align="center" justify="center" class="hero-row fill-height">
        ...
        <v-col
          ...
          md="5"
          lg="4"
          class="d-flex justify-center justify-md-end hero-col-photo"
        >
...
.photo-ring {
  ...
  box-shadow:
    0 24px 60px rgba(74, 143, 104, 0.22),
    0 0 0 6px rgba(74, 143, 104, 0.08);
  transition:
